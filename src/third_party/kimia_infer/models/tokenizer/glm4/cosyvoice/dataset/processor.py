...
try:
    spk_embedding_dir = os.environ["COSYVOICE_SPK_EMBEDDING_DIR"]
    MAIN_SPK_EMBEDDING=torch.load(os.path.join(spk_embedding_dir, "mean_embedding.pt"))
    GPT_SPK_EMBEDDING=torch.load(os.path.join(spk_embedding_dir, "spk_mean_embeddings.pt"))
except:
        ...
        try:
            ...
            for conv in entry["conversations"]:
                if "response_wav" in conv:
                    wav_path = os.path.join(os.environ.get("COSYVOICE_SFT_AUDIO_DIR", "."), conv['response_wav'])
